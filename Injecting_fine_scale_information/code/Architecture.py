...
import argparse
import wandb
os.environ["WANDB_API_KEY"] = "4d5fda823793f79909c9b1b6c926459857ee23b2"
os.environ["WANDB_MODE"] = "offline"
wandb.init(project="SuperRes")
...
#             print("fake_for_d.shape")
        ...
        if (epoch % 3) == 0:
            ...
            if (epoch % 60) == 0:
                ...
                torch.save(netG.state_dict(), PATH_G_wo_ext + str(epoch) +
                           '.pth')
